...
//=========================================================
// HEFFERNAN: WITH HELP OF DOOMMUSIC MADE THE HGRUNT AUTOFIRE!!!!!!
...
void CHGruntRepel::RepelUse ( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	*/
	...
	ClearBits( pGrunt->pev->weapons, HGRUNT_HANDGRENADE );
	ClearBits( pGrunt->pev->weapons, HGRUNT_GRENADELAUNCHER );
	ClearBits( pGrunt->pev->weapons, HGRUNT_SHOTGUN );
	pGrunt->pev->weapons = HGRUNT_9MMAR;
