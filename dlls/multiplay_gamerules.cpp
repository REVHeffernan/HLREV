...
// override some values for multiplay.
	...
	// Combat Knife
	gSkillData.plrDmgCombatKnife = 25;
	...
	// Flamethrower
	gSkillData.plrDmgFlamethrower = 20;
...
BOOL CHalfLifeMultiplay :: GetNextBestWeapon( CBasePlayer *pPlayer, CBasePlayerItem *pCurrentWeapon )
{
	...
	// at least get the combat knife, but ya never know.
	if ( !pBest )
	{
		return FALSE;
	}
...
void CHalfLifeMultiplay :: PlayerSpawn( CBasePlayer *pPlayer )
{
	...
	if ( addDefault )
	{
		...
		pPlayer->GiveAmmo( 48, "9mm", _9MM_MAX_CARRY ); // 4 full reloads
	}
}
