...
//	virtual void Think( void );
	...
	void RemoveItems( int iWeaponMask, int i9mm, int i357, int iBuck, int iBolt, int iARGren, int iRock, int iGren, int iMP5, int iHerbRed, int iHerbGreen, int iSpray, int iFlame );
	...
	void EntityInfoThink( void );
	void StunThink( void );

	float m_flNextEntityInfoTime;
