...
void HUD_InitClientWeapons( void )
{
	...
	HUD_PrepEntity( &g_ColtSAA, &player );
...
void HUD_WeaponsPostThink( local_state_s *from, local_state_s *to, usercmd_t *cmd, double time, unsigned int random_seed )
{
	...
	{
		case WEAPON_COMBAT_KNIFE: pWeapon = &g_CombatKnife; break;
		case WEAPON_BERETTA: pWeapon = &g_Beretta; break;
		case WEAPON_COLT_SAA: pWeapon = &g_ColtSAA; break;
		...
		case WEAPON_HERB_RED:
			pWeapon = &g_HerbRed;
			break;

		case WEAPON_HERB_GREEN:
			pWeapon = &g_HerbGreen;
			break;
...
//		pCurrent->m_flPumpTime			= pfrom->m_flPumpTime;
	...
	player.ammo_mp5		= (int)from->client.vuser2[0];
	player.ammo_herb_red = (int)from->client.vuser3[0];
	player.ammo_herb_green = (int)from->client.vuser3[1];
	player.ammo_spray = (int)from->client.vuser3[2];
	player.ammo_flame = (int)from->client.ammo_cells;
	...
	to->client.ammo_cells				= player.ammo_flame;
	to->client.ammo_nails				= player.ammo_bolts;
	to->client.ammo_shells				= player.ammo_buckshot;
	to->client.ammo_rockets				= player.ammo_rockets;
	to->client.vuser2[0]				= player.ammo_mp5;
	to->client.vuser3[0]				= player.ammo_herb_red;
	to->client.vuser3[1]				= player.ammo_herb_green;
	to->client.vuser3[2]				= player.ammo_spray;
	...
	{		
		...
		HUD_SendWeaponAnim( to->client.weaponanim, 0, 0 );
	}
