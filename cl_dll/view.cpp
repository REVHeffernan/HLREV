...
int V_FindViewModelByWeaponModel(int weaponindex)
{
	...
	static char * modelmap[][2] =	{
		...
		{ "models/p_sti.mdl",			"models/v_sti.mdl"			},
		{ "models/p_9mmAR.mdl",			"models/v_9mmAR.mdl"		},
		{ "models/p_shotgun.mdl",		"models/v_shotgun.mdl"		},
		{ "models/p_crossbow.mdl",		"models/v_crossbow.mdl"		},
		{ "models/p_mp5navy.mdl",		"models/v_mp5navy.mdl"		},
		{ "models/p_herb_green.mdl",	"models/v_herb_green.mdl"	},
		{ "models/p_herb_red.mdl",		"models/v_herb_red.mdl"		},
		{ "models/p_spray.mdl",			"models/v_spray.mdl"		},
		{ "models/p_grenade.mdl",		"models/v_grenade.mdl"		},
		{ "models/p_glauncher.mdl",		"models/v_glauncher.mdl"	},
		{ "models/p_rpg.mdl",			"models/v_rpg.mdl"			},
		{ "models/p_flamethrower.mdl",	"models/v_flamethrower.mdl" },
		{ NULL, NULL } };
